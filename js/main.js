...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoia2pzd2Vuc28iLCJhIjoiY2psbWhybnBhMThkeTNrbXh1am04dTJqayJ9.-WSnXYbNFemnEmcIH3_XXQ',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  image.setAttribute('alt', "Dining experience at " + restaurant.name);
  li.append(image);
